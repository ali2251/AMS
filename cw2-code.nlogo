...
to update-intentions
  ...
  [
     ...
     if get-intention = (word "move-towards-dest " coords) [add-intention (word "move-towards-dest " coords) (word "at-dest " coords) ]
     ;; 1. move towards the location of the fire, achieved when we arrive
